...
const translations = {
  pt: {
    ...
    "dash.hero_desc": "Rise Mindr: A verdadeira vitória começa antes da ação. Reprograme seus pensamentos e conquiste resultados extraordinarios.",
  ...
  en: {
    ...
    "dash.hero_desc": "Rise Mindr: True victory begins before action. Reprogram your thoughts and achieve extraordinary results.",
    ...
    "planner.placeholder_goal": "Ex: Learn basic English, Start a business...",
    ...
    "about.inspiration_desc": "This app is based on fundamental principles of success and high performance. We believe true victory begins silently, within the mind, before manifesting in the real world.",
    ...
    "about.purpose_desc": "We created Rise Mindr to be your daily evolution companion, uniting ancient wisdom with AI technology.",
  ...
  es: {
    ...
    "dash.card_gratitude_desc": "Eleve tu vibración agradeciendo lo que ya tienes.",
    "dash.new_tag": "Nuevo",
