...
const translations = {
  pt: {
    // Auth
    "auth.header_title": "Rise Mindr",
    "auth.header_subtitle": "Mente Abundante - Sua jornada começa agora.",
    ...
    "dash.hero_desc": "Rise Mindr: A verdadeira vitória começa antes da ação. Reprograme seus pensamentos e conquiste resultados extraordinários.",
    ...
    "planner.placeholder_goal": "Ex: Aprender inglês básico, Começar um negócio...",
    ...
    "about.fixed_desc": "Acredita que habilidades são imutáveis. Evita desafios por miedo de falhar.",
    ...
    "about.purpose_desc": "Criamos o Rise Mindr para ser seu companheiro diário de evolução, unindo sabedoria ancestral com tecnologia de Inteligência Artificial.",
  ...
  en: {
    // Auth
    "auth.header_title": "Rise Mindr",
    "auth.header_subtitle": "Abundant Mind - Your journey starts now.",
    ...
    "auth.btn_send_link": "Send Reset Link",
    "auth.back_login": "Back to Login",
    "auth.terms": "Terms of Use & Privacy",
    "auth.error_generic": "Connection error. Please try again.",
    "auth.success_created": "Account created! Please verify your email.",
    ...
    "dash.hero_desc": "Rise Mindr: Unlock your potential, shift your mindset, and achieve extraordinary results.",
    "dash.card_coach_desc": "Personalized mentorship to clear doubts and stay focused.",
    "dash.card_reprogram_desc": "Transform limiting beliefs into empowering thoughts.",
    "dash.card_planner_desc": "Set goals and get a step-by-step action plan.",
    "dash.card_anxiety_desc": "Immediate guided audio to restore your balance.",
    "dash.card_plan7_desc": "Practical roadmap to unlock your mind in one week.",
    ...
    "dash.card_gratitude_desc": "Raise your vibration by appreciating what you have.",
    "dash.new_tag": "New",

    // Planner
    "planner.title": "AI Action Planner",
    "planner.subtitle": "Define a goal and a deadline. Our AI will craft a step-by-step roadmap for you to get there.",
    "planner.label_goal": "Your Goal",
    "planner.placeholder_goal": "Ex: Learn basic Spanish, Start a side hustle...",
    "planner.label_time": "Deadline",
    "planner.placeholder_time": "Ex: 30 days, 3 months...",
    "planner.btn_generate": "Generate Plan",
    "planner.empty_state": "No plans created yet.\nStart now and turn goals into reality.",
    ...
    "reprogram.placeholder_block": "What does your mind tell you that you can't do? Ex: 'I'm not lucky'...",
    ...
    "reprogram.btn_save": "Confirm and Save",
    ...
    "gratitude.history_title": "Blessings History",
    "gratitude.empty_state": "No gratitude recorded yet.\nStart today and watch the magic happen.",

    // Checklist
    "checklist.title": "Daily Ritual",
    "checklist.subtitle": "Don't just check boxes. Feel every small victory and receive insights.",
    "checklist.summary_title": "Captain's Log",

    // Profile
    "profile.title": "Your Profile",
    "profile.subtitle": "Click photo to change your image.",
    "profile.label_name": "How should we call you?",
    "profile.label_mantra": "Power Phrase (Short Mantra)",
    "profile.placeholder_name": "Your name",
    "profile.placeholder_mantra": "Ex: I am disciplined and I conquer my challenges.",
    ...
    "coach.disclaimer": "AI Mentor can make mistakes. Verify important info.",
    ...
    "about.inspiration_desc": "This app relies on fundamental principles of success and high performance. We believe true victory begins silently, within the mind, before manifesting in the real world.",
    "about.mindset_title": "The Power of Transformation",
    "about.mindset_desc": "Many believe winning depends solely on luck or talent, but champions know it all starts with the right mindset. If your mind believes you can't, it sabotages your efforts before you even begin.",
    ...
    "about.growth_desc": "Understands that effort generates growth. Sees failure as a learning opportunity.",
    "about.abundant_title": "Abundant Mindset",
    "about.abundant_desc": "Does not compete, creates. Knows there is room for everyone to win.",
    "about.purpose_title": "Our Purpose",
    "about.purpose_desc": "We created Rise Mindr to be your daily evolution companion, bridging ancient wisdom with AI technology.",
    "about.tools_title": "Explore Tools",
    "about.footer": "Built with focus on your evolution.",
  },
  es: {
    // Auth
    "auth.header_title": "Rise Mindr",
    "auth.header_subtitle": "Mente Abundante - Tu viaje comienza ahora.",
    "auth.tab_login": "Ingresar",
    ...
    // Dashboard
    "dash.hero_title": "MENTE ABUNDANTE",
    "dash.hero_title_span": "Y VICTORIOSA",
    "dash.hero_desc": "Rise Mindr: La verdadera victoria comienza antes de la acción. Reprograma tus pensamientos y conquista resultados extraordinarios.",
    ...
    "planner.btn_generate": "Generar Plan",
    ...
    "reprogram.btn_save": "Confirmar y Guardar",
    "reprogram.btn_cancel": "Cancelar",
    ...
    "gratitude.btn_submit": "Agradecer",
    "gratitude.history_title": "Historial de Bendiciones",
    ...
    "checklist.summary_title": "Bitácora",
