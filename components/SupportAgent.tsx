...
const SupportAgent: React.FC = () => {
  ...
  const resetChat = () => {
    setMessages([{
      role: 'model',
      text: 'Olá! Sou o Assistente Técnico MindShift. Posso ajudar com dúvidas sobre sua conta, funcionalidades do app ou problemas técnicos. Como posso ajudar hoje?'
    }]);
  };
