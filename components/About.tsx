  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 md:space-y-8 animate-fade-in pb-8">
      ...
      <div className="text-center mb-6 md:mb-10 px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-800 mb-3 md:mb-4">Sobre o Mente Abundante</h2>
        ...
        <div className="p-5 md:p-8 space-y-6 md:space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed text-sm md:text-base">
              Criamos este app para ser seu companheiro diário de evolução.
            </p>
          </section>
