...
import { Target, Brain, Trophy, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="relative bg-gradient-to-r from-slate-900 to-slate-800 text-white p-8 md:p-12 rounded-3xl overflow-hidden shadow-xl">
        <div className="absolute top-0 right-0 w-64 h-64 bg-amber-500 rounded-full blur-[80px] opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
        
        <div className="relative z-10 max-w-2xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">
            Mente Abundante <br/> <span className="text-amber-400">& Vencedora</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <button 
              ...
              className="bg-amber-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-amber-600 transition-colors shadow-lg shadow-amber-500/20 flex items-center gap-2"
            >
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center">
        ...
        <div className="mt-4 w-12 h-1 bg-amber-500 mx-auto rounded-full"></div>
      </div>
